      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <div className="flex flex-col md:flex-row-reverse gap-12 items-center bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
          <div className="w-full md:w-1/3">
            ...
            <div className="mt-4 text-center text-slate-800 font-bold text-lg">School Principal</div>
            <div className="text-center text-indigo-600 font-semibold text-sm uppercase tracking-wider">Principal</div>
          </div>
          <div className="w-full md:w-2/3">
             <h2 className="text-3xl font-bold text-indigo-600 mb-6">Principal's Message</h2>
             <div className="text-slate-600 space-y-4 leading-relaxed">
                <p>It is my distinct pleasure to welcome prospective students and parents to EduPro School. We pride ourselves on offering a curriculum that is rigorous, balanced, and tailored to meet the needs of every individual student.</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
           <div className="bg-white p-8 border border-slate-200 rounded-xl hover:border-indigo-600 hover:shadow-lg transition-all cursor-pointer group">
             <FileText size={40} className="text-indigo-600 mb-4 group-hover:scale-110 transition-transform" />
           ...
           <div className="bg-white p-8 border border-slate-200 rounded-xl hover:border-sky-500 hover:shadow-lg transition-all cursor-pointer group">
             <CalendarCheck size={40} className="text-sky-500 mb-4 group-hover:scale-110 transition-transform" />
           ...
           <div className="bg-white p-8 border border-slate-200 rounded-xl hover:border-indigo-600 hover:shadow-lg transition-all cursor-pointer group">
             <HelpCircle size={40} className="text-indigo-600 mb-4 group-hover:scale-110 transition-transform" />
