    ...
    <div className="w-full bg-white">
      <div className="bg-indigo-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-300 max-w-2xl mx-auto">Rules, Code of Conduct, and daily academic procedures at EduPro.</p>
        </div>
      </div>

      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
        <section>
          <h2 className="text-3xl font-bold text-sky-600 mb-8 pb-2 border-b-2 border-slate-100 flex items-center gap-3">
            <BookOpen className="text-indigo-600" /> Rules & Code of Conduct
          </h2>
          
          <div className="space-y-6">
            <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-indigo-600 mb-4 flex items-center gap-2"><Clock size={20} className="text-sky-600" /> Daily Attendance</h3>
            ...
            <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-indigo-600 mb-4">Uniform & Grooming</h3>
              <ul className="space-y-3 text-slate-700">
            ...
            <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-indigo-600 mb-4">Discipline</h3>
              <ul className="space-y-3 text-slate-700">
