    ...
    <div className="w-full bg-slate-50">
      <div className="bg-[#C82026] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/80 max-w-2xl mx-auto">Latest updates, events, and media from GPHIS.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {[1, 2, 3].map((item) => (
             <div key={item} className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow flex flex-col">
               ...
               <div className="p-6 flex flex-col flex-1">
                 <div className="text-xs font-bold text-[#C82026] mb-2 flex items-center gap-1 uppercase tracking-wider">
                   <Calendar size={14} /> {new Date().toLocaleDateString()}
                 </div>
                 <h3 className="text-xl font-bold text-[#002157] mb-3">Annual Science Fair {new Date().getFullYear()} Concludes Successfully</h3>
                 ...
                 <button className="mt-auto text-[#002157] font-semibold hover:text-[#C82026] transition-colors self-start text-sm">Read Full Story</button>
               </div>
             </div>
          ))}
        </div>
        ...
        {/* Video Gallery */}
        <h2 className="text-2xl font-bold text-[#002157] mb-8 mt-20 pb-2 border-b-2 border-slate-200 flex items-center gap-2">
          <Video className="text-[#C82026]" /> Promotional Videos
        </h2>
        <div className="grid md:grid-cols-2 gap-8">
           <div className="aspect-video bg-slate-900 rounded-xl overflow-hidden flex items-center justify-center cursor-pointer group">
              <div className="w-16 h-16 bg-[#C82026] text-white rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
