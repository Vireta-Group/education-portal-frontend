      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
           <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 flex flex-col items-center text-center">
              <Trophy size={48} className="text-indigo-600 mb-4" />
          ...
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 flex flex-col items-center text-center">
              <Palette size={48} className="text-indigo-600 mb-4" />
          ...
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 flex flex-col items-center text-center">
              <Music size={48} className="text-sky-600 mb-4" />
        ...
        {/* Gallery Placeholder */}
        <h2 className="text-3xl font-bold text-indigo-600 mb-8 text-center uppercase tracking-wide">Activity Gallery</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
           {[1, 2, 3, 4, 5, 6].map((i) => (
             <div key={i} className="aspect-video bg-slate-200 rounded-lg overflow-hidden relative group">
                 <div className="absolute inset-0 bg-indigo-600/20 group-hover:bg-transparent transition-colors duration-300" />
